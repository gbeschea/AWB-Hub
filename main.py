...
# Asigură-te că această linie este ștearsă sau comentată
# from dependencies import get_templates 
from routes import (
    store_categories, printing, logs, orders, sync, labels,
    settings as settings_router,  # Am redenumit aici
    validation, webhooks, couriers
)
...
async def startup_event():
    ...
    """
        # --- MODIFICARE: Adaugă acest bloc de cod ---
    async with engine.begin() as conn:
        # await conn.run_sync(models.Base.metadata.drop_all) # Decomentează pentru a șterge tabelele la fiecare pornire (pentru testare)
